...
# 数据加载
emails = pd.read_csv("/Users/amy/Downloads/PageRank-master/input/Emails.csv")
# 读取别名文件
file = pd.read_csv("/Users/amy/Downloads/PageRank-master/input/Aliases.csv")
aliases = {}
for index, row in file.iterrows():
    aliases[row['Alias']] = row['PersonId']
# 读取人名文件
file = pd.read_csv("/Users/amy/Downloads/PageRank-master/input/Persons.csv")
persons = {}
for index, row in file.iterrows():
