...
# 数据加载，避免中文乱码问题
data_ori = pd.read_csv('/Users/amy/Downloads/EM_data-master/heros7.csv', encoding='gb18030')
...
data_ori.to_csv('/Users/amy/Downloads/EM_data-master/hero_out.csv', index=False, sep=',')
